...
import './SearchResultListEntry.css';
import '../Main/MovieCardListEntry.css';
...
class SearchResultListEntry extends Component {
   constructor(props) {
      super(props);
      this.state = {
         likeFilled: false,
...
export default withRouter(SearchResultListEntry);
